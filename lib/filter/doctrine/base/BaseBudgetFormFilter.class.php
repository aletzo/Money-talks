...
abstract class BaseBudgetFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'tags_combined' => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ...
    $this->setValidators(array(
      ...
      'tags_combined' => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
